...
- ONLY these characters are allowed: A-Z, 0-9, SPACE, and the DOLLAR SIGN ($).
...
- Numbers with decimals like 22.5 become 22 5 (period becomes space). Prices like $40 stay as $40. A price like $19.99 becomes $19 99.
...
- Every character on the line must be: A-Z, 0-9, SPACE, or $.
- No tabs. No lowercase. No punctuation except $. No brackets. No dashes. No slashes.
...
def sanitize_line(text: str) -> str:
    ...
    s = s.replace("\t", " ")
    # Keep only A-Z, 0-9, space, $. Everything else becomes a space.
    s = re.sub(r"[^A-Z0-9 $]", " ", s)
