...
const BUILD_ID = "2026-09-08-disk-stream-parallel-v25.74";
...
jnjLog("BOOT", "v25.74 boot. BUILD_ID:", "2026-09-08-disk-stream-parallel-v25.74");
...
try {
  ...
  badge.textContent = `v25.74 · ${BUILD_ID}`;
