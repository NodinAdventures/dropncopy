...
const BUILD_ID = "2026-09-21-v26.17.6-keep-rows-conservative";
...
jnjLog("BOOT", "v26.17.6 boot. BUILD_ID:", "2026-09-21-v26.17.6-keep-rows-conservative");
...
try {
  ...
  badge.textContent = `v26.17.6 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.6 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.6 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
