...
const BUILD_ID = "2026-09-21-v26.17.15-verified-count-enforced";
...
jnjLog("BOOT", "v26.17.15 boot. BUILD_ID:", "2026-09-21-v26.17.15-verified-count-enforced");
...
try {
  ...
  badge.textContent = `v26.17.15 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.15 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.15 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
