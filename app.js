...
const BUILD_ID = "2026-08-31-deterministic-first-row-v25.70";
...
jnjLog("BOOT", "v25.70 boot. BUILD_ID:", "2026-08-31-deterministic-first-row-v25.70");
...
try {
  ...
  badge.textContent = `v25.70 · ${BUILD_ID}`;
