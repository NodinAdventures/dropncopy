...
const BUILD_ID = "2026-09-21-v26.17.17-three-anchor-check";
...
jnjLog("BOOT", "v26.17.17 boot. BUILD_ID:", "2026-09-21-v26.17.17-three-anchor-check");
...
try {
  ...
  badge.textContent = `v26.17.17 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.17 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.17 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
