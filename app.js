...
const BUILD_ID = "2026-09-21-v26.17.5-drop-crossed-out";
...
jnjLog("BOOT", "v26.17.5 boot. BUILD_ID:", "2026-09-21-v26.17.5-drop-crossed-out");
...
try {
  ...
  badge.textContent = `v26.17.5 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.5 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.5 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
