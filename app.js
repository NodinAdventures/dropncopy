...
const BUILD_ID = "2026-09-21-v26.16.2-top-only-strict";
...
jnjLog("BOOT", "v26.16.2 boot. BUILD_ID:", "2026-09-21-v26.16.2-top-only-strict");
...
try {
  ...
  badge.textContent = `v26.16.2 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.16.2 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.16.2 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
