...
const BUILD_ID = "2026-08-25-jnj-zip-subfolder-backslash-paths-v25.14";
...
jnjLog("BOOT", "v25.14 boot. BUILD_ID:", "2026-08-25-jnj-zip-subfolder-backslash-paths-v25.14");
...
try {
  ...
  badge.textContent = `v25.14 · ${BUILD_ID}`;
