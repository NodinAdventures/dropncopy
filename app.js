...
const BUILD_ID = "2026-09-20-v26.7-qr-hardened";
...
jnjLog("BOOT", "v26.7 boot. BUILD_ID:", "2026-09-20-v26.7-qr-hardened");
...
try {
  ...
  badge.textContent = `v26.7 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.7 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.7 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
