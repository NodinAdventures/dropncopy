...
const BUILD_ID = "2026-09-21-v26.17.8-wrap-line-fix";
...
jnjLog("BOOT", "v26.17.8 boot. BUILD_ID:", "2026-09-21-v26.17.8-wrap-line-fix");
...
try {
  ...
  badge.textContent = `v26.17.8 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.8 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.8 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
