...
const BUILD_ID = "2026-09-21-v26.16.1-top-only";
...
jnjLog("BOOT", "v26.16.1 boot. BUILD_ID:", "2026-09-21-v26.16.1-top-only");
...
try {
  ...
  badge.textContent = `v26.16.1 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.16.1 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.16.1 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
