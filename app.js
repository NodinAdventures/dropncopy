...
const BUILD_ID = "2026-08-25-fix-ai-hallucinated-seller-num-v25.25";
...
jnjLog("BOOT", "v25.25 boot. BUILD_ID:", "2026-08-25-fix-ai-hallucinated-seller-num-v25.25");
...
try {
  ...
  badge.textContent = `v25.25 · ${BUILD_ID}`;
