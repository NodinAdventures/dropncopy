...
const BUILD_ID = "2026-09-21-v26.17.14-sequence-enforced";
...
jnjLog("BOOT", "v26.17.14 boot. BUILD_ID:", "2026-09-21-v26.17.14-sequence-enforced");
...
try {
  ...
  badge.textContent = `v26.17.14 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.14 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.14 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
