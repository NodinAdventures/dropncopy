...
const BUILD_ID = "2026-08-25-default-duration-7-days-v25.15";
...
jnjLog("BOOT", "v25.15 boot. BUILD_ID:", "2026-08-25-default-duration-7-days-v25.15");
...
try {
  ...
  badge.textContent = `v25.15 · ${BUILD_ID}`;
