...
const BUILD_ID = "2026-09-20-v26.9-qr-only";
...
jnjLog("BOOT", "v26.9 boot. BUILD_ID:", "2026-09-20-v26.9-qr-only");
...
try {
  ...
  badge.textContent = `v26.9 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.9 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.9 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
