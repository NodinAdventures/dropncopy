...
const BUILD_ID = "2026-09-22-v26.17.21-wrap-direction";
...
jnjLog("BOOT", "v26.17.21 boot. BUILD_ID:", "2026-09-22-v26.17.21-wrap-direction");
...
try {
  ...
  badge.textContent = `v26.17.21 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.21 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.21 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
