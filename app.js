...
const BUILD_ID = "2026-09-21-v26.17.10-blackout-printed-text";
...
jnjLog("BOOT", "v26.17.10 boot. BUILD_ID:", "2026-09-21-v26.17.10-blackout-printed-text");
...
try {
  ...
  badge.textContent = `v26.17.10 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.10 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.10 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
