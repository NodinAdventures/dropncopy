...
const BUILD_ID = "2026-08-25-better-seller-extract-v25.1";
...
jnjLog("BOOT", "v25.1 boot. BUILD_ID:", "2026-08-25-better-seller-extract-v25.1");
...
try {
  ...
  badge.textContent = `v25.1 · ${BUILD_ID}`;
