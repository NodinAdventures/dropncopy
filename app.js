...
const BUILD_ID = "2026-09-21-v26.17.11-wrap-parent-and-ocr-hints";
...
jnjLog("BOOT", "v26.17.11 boot. BUILD_ID:", "2026-09-21-v26.17.11-wrap-parent-and-ocr-hints");
...
try {
  ...
  badge.textContent = `v26.17.11 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.11 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.11 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
