...
const BUILD_ID = "2026-09-21-v26.17.9-wrap-order";
...
jnjLog("BOOT", "v26.17.9 boot. BUILD_ID:", "2026-09-21-v26.17.9-wrap-order");
...
try {
  ...
  badge.textContent = `v26.17.9 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.9 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.9 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
