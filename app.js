...
const BUILD_ID = "2026-09-21-v26.17.16-wrap-above-real";
...
jnjLog("BOOT", "v26.17.16 boot. BUILD_ID:", "2026-09-21-v26.17.16-wrap-above-real");
...
try {
  ...
  badge.textContent = `v26.17.16 · ${BUILD_ID}`;
  ...
  async function jnjPollLbState() {
    try {
      ...
      if (lbOn) {
        badge.textContent = `v26.17.16 · A:${a} B:${b}`;
      } else {
        badge.textContent = `v26.17.16 · A:${a} (single key)`;
      }
    } catch {}
  }
  jnjPollLbState();
